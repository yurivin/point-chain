...
Generate a new key/mnemonic for validator: ```evmosd keys add validatorkey``` where validatorkey is your validator custom name.
...
Run the init script
Init you validator: ```evmosd init validatorkey --chain-id point_10721-1```
...
Also you can check your VotingPower by running: ```evmosd status```
